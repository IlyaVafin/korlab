...
export default function Technology() {
	return (
		<section className='mt-10 mb-10'>
			<div className='flex flex-col items-center lg:flex-row lg:gap-3 lg:h-[308px] lg:items-start'>
				...
				<OrangeCard className='max-w-[793px] lg:max-w-[563px] mt-2.5 mb-2.5 pb-[19px] h-full lg:mt-0 '>
					<Typography
						variant='description'
